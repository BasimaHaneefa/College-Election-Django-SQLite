...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Student', '0007_delete_tbl_collegepolling'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polling_student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='Student.tbl_collegecandidate')),
